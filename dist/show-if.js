...
(function (root, factory) {
  ...
  showIf._bindCheckbox = function ($input, $allControls, $target) {
    ...
    if ($siblingTargets.length) {
      $siblingTargets.map(function ($ibling) {
  ...
  showIf.toggleAllElements = function () {
    ...
    try {
      for (var _iterator3 = showIf.$targets[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
